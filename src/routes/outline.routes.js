...
router.post("/", auth, ensureOutlineSubmissionPeriodOpen, attachProgramStudi, outlineController.create);
...
router.patch("/:id", auth, ensureOutlineSubmissionPeriodOpen, attachProgramStudi, outlineController.resubmit);
